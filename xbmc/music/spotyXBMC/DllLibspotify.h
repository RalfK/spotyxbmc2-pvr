...
public:
    ...
    virtual sp_error sp_session_release(sp_session *) = 0;
    virtual sp_error sp_session_login(sp_session *, const char *, const char *, bool , const char *) = 0;
    virtual sp_error sp_session_relogin(sp_session *) = 0;
    virtual int sp_session_remembered_user(sp_session *, char *, size_t ) = 0;
    virtual const char * sp_session_user_name(sp_session *) = 0;
    virtual sp_error sp_session_forget_me(sp_session *) = 0;
    virtual sp_user * sp_session_user(sp_session *) = 0;
    virtual sp_error sp_session_logout(sp_session *) = 0;
    virtual sp_error sp_session_flush_caches(sp_session *) = 0;
    virtual sp_connectionstate sp_session_connectionstate(sp_session *) = 0;
    virtual void * sp_session_userdata(sp_session *) = 0;
    virtual sp_error sp_session_set_cache_size(sp_session *, size_t ) = 0;
    virtual sp_error sp_session_process_events(sp_session *, int *) = 0;
    virtual sp_error sp_session_player_load(sp_session *, sp_track *) = 0;
    virtual sp_error sp_session_player_seek(sp_session *, int ) = 0;
    virtual sp_error sp_session_player_play(sp_session *, bool ) = 0;
    virtual sp_error sp_session_player_unload(sp_session *) = 0;
    ...
    virtual sp_error sp_session_preferred_bitrate(sp_session *, sp_bitrate ) = 0;
    virtual sp_error sp_session_preferred_offline_bitrate(sp_session *, sp_bitrate , bool ) = 0;
    virtual bool sp_session_get_volume_normalization(sp_session *) = 0;
    virtual sp_error sp_session_set_volume_normalization(sp_session *, bool ) = 0;
    virtual sp_error sp_session_set_private_session(sp_session *, bool ) = 0;
    virtual bool sp_session_is_private_session(sp_session *) = 0;
    virtual sp_error sp_session_set_scrobbling(sp_session *, sp_social_provider , sp_scrobbling_state ) = 0;
    virtual sp_error sp_session_is_scrobbling(sp_session *, sp_social_provider , sp_scrobbling_state* ) = 0;
    virtual sp_error sp_session_is_scrobbling_possible(sp_session *, sp_social_provider , bool* ) = 0;
    virtual sp_error sp_session_set_social_credentials(sp_session *, sp_social_provider , const char* , const char* ) = 0;
    virtual sp_error sp_session_set_connection_type(sp_session *, sp_connection_type ) = 0;
    virtual sp_error sp_session_set_connection_rules(sp_session *, sp_connection_rules ) = 0;
    ...
    virtual sp_link * sp_link_create_from_album_cover(sp_album *, sp_image_size ) = 0;
    virtual sp_link * sp_link_create_from_artist(sp_artist *) = 0;
    virtual sp_link * sp_link_create_from_artist_portrait(sp_artist *, sp_image_size ) = 0;
    ...
    virtual sp_error sp_link_add_ref(sp_link *) = 0;
    virtual sp_error sp_link_release(sp_link *) = 0;
    ...
    virtual sp_track * sp_track_get_playable(sp_session *, sp_track *) = 0;
    virtual bool sp_track_is_placeholder(sp_track *) = 0;
    virtual bool sp_track_is_starred(sp_session *, sp_track *) = 0;
    virtual sp_error sp_track_set_starred(sp_session *, sp_track *const*, int , bool ) = 0;
    ...
    virtual sp_error sp_track_add_ref(sp_track *) = 0;
    virtual sp_error sp_track_release(sp_track *) = 0;
    ...
    virtual const byte * sp_album_cover(sp_album *, sp_image_size ) = 0;
    ...
    virtual sp_error sp_album_add_ref(sp_album *) = 0;
    virtual sp_error sp_album_release(sp_album *) = 0;
    virtual const char * sp_artist_name(sp_artist *) = 0;
    virtual bool sp_artist_is_loaded(sp_artist *) = 0;
    virtual const byte * sp_artist_portrait(sp_artist *, sp_image_size ) = 0;
    virtual sp_error sp_artist_add_ref(sp_artist *) = 0;
    virtual sp_error sp_artist_release(sp_artist *) = 0;
    ...
    virtual sp_error sp_albumbrowse_add_ref(sp_albumbrowse *) = 0;
    virtual sp_error sp_albumbrowse_release(sp_albumbrowse *) = 0;
    ...
    virtual int sp_artistbrowse_num_tophit_tracks(sp_artistbrowse *) = 0;
    virtual sp_track * sp_artistbrowse_tophit_track(sp_artistbrowse *, int ) = 0;
    ...
    virtual sp_error sp_artistbrowse_add_ref(sp_artistbrowse *) = 0;
    virtual sp_error sp_artistbrowse_release(sp_artistbrowse *) = 0;
    ...
    virtual sp_error sp_image_add_load_callback(sp_image *, image_loaded_cb *, void *) = 0;
    virtual sp_error sp_image_remove_load_callback(sp_image *, image_loaded_cb *, void *) = 0;
    ...
    virtual sp_error sp_image_add_ref(sp_image *) = 0;
    virtual sp_error sp_image_release(sp_image *) = 0;
    virtual sp_search * sp_search_create(sp_session *, const char *, int , int , int , int , int , int , int , int , sp_search_type , search_complete_cb *, void *) = 0;
    ...
    virtual int sp_search_num_playlists(sp_search *) = 0;
    virtual sp_playlist * sp_search_playlist(sp_search *, int ) = 0;
    virtual const char * sp_search_playlist_name(sp_search *, int ) = 0;
    virtual const char * sp_search_playlist_uri(sp_search *, int ) = 0;
    virtual const char * sp_search_playlist_image_uri(sp_search *, int ) = 0;
    ...
    virtual int sp_search_total_playlists(sp_search *) = 0;
    virtual sp_error sp_search_add_ref(sp_search *) = 0;
    virtual sp_error sp_search_release(sp_search *) = 0;
    virtual bool sp_playlist_is_loaded(sp_playlist *) = 0;
    virtual sp_error sp_playlist_add_callbacks(sp_playlist *, sp_playlist_callbacks *, void *) = 0;
    virtual sp_error sp_playlist_remove_callbacks(sp_playlist *, sp_playlist_callbacks *, void *) = 0;
    ...
    virtual sp_error sp_playlist_set_collaborative(sp_playlist *, bool ) = 0;
    virtual sp_error sp_playlist_set_autolink_tracks(sp_playlist *, bool ) = 0;
    ...
    virtual sp_error sp_playlist_subscribers_free(sp_subscribers *) = 0;
    virtual sp_error sp_playlist_update_subscribers(sp_session *, sp_playlist *) = 0;
    virtual bool sp_playlist_is_in_ram(sp_session *, sp_playlist *) = 0;
    virtual sp_error sp_playlist_set_in_ram(sp_session *, sp_playlist *, bool ) = 0;
    virtual sp_playlist * sp_playlist_create(sp_session *, sp_link *) = 0;
    virtual sp_error sp_playlist_set_offline_mode(sp_session *, sp_playlist *, bool ) = 0;
    ...
    virtual sp_error sp_playlist_add_ref(sp_playlist *) = 0;
    virtual sp_error sp_playlist_release(sp_playlist *) = 0;
    virtual sp_error sp_playlistcontainer_add_callbacks(sp_playlistcontainer *, sp_playlistcontainer_callbacks *, void *) = 0;
    virtual sp_error sp_playlistcontainer_remove_callbacks(sp_playlistcontainer *, sp_playlistcontainer_callbacks *, void *) = 0;
    ...
    virtual sp_error sp_playlistcontainer_add_ref(sp_playlistcontainer *) = 0;
    virtual sp_error sp_playlistcontainer_release(sp_playlistcontainer *) = 0;
    virtual int sp_playlistcontainer_get_unseen_tracks(sp_playlistcontainer *, sp_playlist *, sp_track **, int ) = 0;
    virtual int sp_playlistcontainer_clear_unseen_tracks(sp_playlistcontainer *, sp_playlist *) = 0;
    ...
    virtual sp_error sp_user_add_ref(sp_user *) = 0;
    virtual sp_error sp_user_release(sp_user *) = 0;
    ...
    virtual sp_error sp_toplistbrowse_add_ref(sp_toplistbrowse *) = 0;
    virtual sp_error sp_toplistbrowse_release(sp_toplistbrowse *) = 0;
    ...
    virtual sp_error sp_inbox_add_ref(sp_inbox *) = 0;
    virtual sp_error sp_inbox_release(sp_inbox *) = 0;
...
class DllLibspotify : public DllDynamic, DllLibspotifyInterface
{
    ...
    DEFINE_METHOD1(sp_error, sp_session_release, (sp_session *p1))
    DEFINE_METHOD5(sp_error, sp_session_login, (sp_session *p1, const char *p2, const char *p3, bool p4, const char *p5))
    ...
    DEFINE_METHOD1(const char *, sp_session_user_name, (sp_session *p1))
    DEFINE_METHOD1(sp_error, sp_session_forget_me, (sp_session *p1))
    DEFINE_METHOD1(sp_user *, sp_session_user, (sp_session *p1))
    DEFINE_METHOD1(sp_error, sp_session_logout, (sp_session *p1))
    DEFINE_METHOD1(sp_error, sp_session_flush_caches, (sp_session *p1))
    ...
    DEFINE_METHOD2(sp_error, sp_session_set_cache_size, (sp_session *p1, size_t p2))
    DEFINE_METHOD2(sp_error, sp_session_process_events, (sp_session *p1, int *p2))
    DEFINE_METHOD2(sp_error, sp_session_player_load, (sp_session *p1, sp_track *p2))
    DEFINE_METHOD2(sp_error, sp_session_player_seek, (sp_session *p1, int p2))
    DEFINE_METHOD2(sp_error, sp_session_player_play, (sp_session *p1, bool p2))
    DEFINE_METHOD1(sp_error, sp_session_player_unload, (sp_session *p1))
    ...
    DEFINE_METHOD2(sp_error, sp_session_preferred_bitrate, (sp_session *p1, sp_bitrate p2))
    DEFINE_METHOD3(sp_error, sp_session_preferred_offline_bitrate, (sp_session *p1, sp_bitrate p2, bool p3))
    DEFINE_METHOD1(bool, sp_session_get_volume_normalization, (sp_session *p1))
    DEFINE_METHOD2(sp_error, sp_session_set_volume_normalization, (sp_session *p1, bool p2))
    DEFINE_METHOD2(sp_error, sp_session_set_private_session, (sp_session *p1, bool p2))
    DEFINE_METHOD1(bool, sp_session_is_private_session, (sp_session *p1))
    DEFINE_METHOD3(sp_error, sp_session_set_scrobbling, (sp_session *p1, sp_social_provider p2, sp_scrobbling_state p3))
    DEFINE_METHOD3(sp_error, sp_session_is_scrobbling, (sp_session *p1, sp_social_provider p2, sp_scrobbling_state* p3))
    DEFINE_METHOD3(sp_error, sp_session_is_scrobbling_possible, (sp_session *p1, sp_social_provider p2, bool* p3))
    DEFINE_METHOD4(sp_error, sp_session_set_social_credentials, (sp_session *p1, sp_social_provider p2, const char* p3, const char* p4))
    DEFINE_METHOD2(sp_error, sp_session_set_connection_type, (sp_session *p1, sp_connection_type p2))
    DEFINE_METHOD2(sp_error, sp_session_set_connection_rules, (sp_session *p1, sp_connection_rules p2))
    ...
    DEFINE_METHOD2(sp_link *, sp_link_create_from_album_cover, (sp_album *p1, sp_image_size p2))
    DEFINE_METHOD1(sp_link *, sp_link_create_from_artist, (sp_artist *p1))
    DEFINE_METHOD2(sp_link *, sp_link_create_from_artist_portrait, (sp_artist *p1, sp_image_size p2))
    ...
    DEFINE_METHOD1(sp_error, sp_link_add_ref, (sp_link *p1))
    DEFINE_METHOD1(sp_error, sp_link_release, (sp_link *p1))
    ...
    DEFINE_METHOD2(sp_track *, sp_track_get_playable, (sp_session *p1, sp_track *p2))
    DEFINE_METHOD1(bool, sp_track_is_placeholder, (sp_track *p1))
    DEFINE_METHOD2(bool, sp_track_is_starred, (sp_session *p1, sp_track *p2))
    DEFINE_METHOD4(sp_error, sp_track_set_starred, (sp_session *p1, sp_track *const*p2, int p3, bool p4))
    ...
    DEFINE_METHOD1(sp_error, sp_track_add_ref, (sp_track *p1))
    DEFINE_METHOD1(sp_error, sp_track_release, (sp_track *p1))
    ...
    DEFINE_METHOD2(const byte *, sp_album_cover, (sp_album *p1, sp_image_size p2))
    ...
    DEFINE_METHOD1(sp_error, sp_album_add_ref, (sp_album *p1))
    DEFINE_METHOD1(sp_error, sp_album_release, (sp_album *p1))
    DEFINE_METHOD1(const char *, sp_artist_name, (sp_artist *p1))
    DEFINE_METHOD1(bool, sp_artist_is_loaded, (sp_artist *p1))
    DEFINE_METHOD2(const byte *, sp_artist_portrait, (sp_artist *p1, sp_image_size p2))
    DEFINE_METHOD1(sp_error, sp_artist_add_ref, (sp_artist *p1))
    DEFINE_METHOD1(sp_error, sp_artist_release, (sp_artist *p1))
    ...
    DEFINE_METHOD1(sp_error, sp_albumbrowse_add_ref, (sp_albumbrowse *p1))
    DEFINE_METHOD1(sp_error, sp_albumbrowse_release, (sp_albumbrowse *p1))
    ...
    DEFINE_METHOD1(int, sp_artistbrowse_num_tophit_tracks, (sp_artistbrowse *p1))
    DEFINE_METHOD2(sp_track *, sp_artistbrowse_tophit_track, (sp_artistbrowse *p1, int p2))
    ...
    DEFINE_METHOD1(sp_error, sp_artistbrowse_add_ref, (sp_artistbrowse *p1))
    DEFINE_METHOD1(sp_error, sp_artistbrowse_release, (sp_artistbrowse *p1))
    ...
    DEFINE_METHOD3(sp_error, sp_image_add_load_callback, (sp_image *p1, image_loaded_cb *p2, void *p3))
    DEFINE_METHOD3(sp_error, sp_image_remove_load_callback, (sp_image *p1, image_loaded_cb *p2, void *p3))
    ...
    DEFINE_METHOD1(sp_error, sp_image_add_ref, (sp_image *p1))
    DEFINE_METHOD1(sp_error, sp_image_release, (sp_image *p1))
    DEFINE_METHOD13(sp_search *, sp_search_create, (sp_session *p1, const char *p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, sp_search_type p11, search_complete_cb *p12, void *p13))
    ...
    DEFINE_METHOD1(int, sp_search_num_playlists, (sp_search *p1))
    DEFINE_METHOD2(sp_playlist *, sp_search_playlist, (sp_search *p1, int p2))
    DEFINE_METHOD2(const char *, sp_search_playlist_name, (sp_search *p1, int p2))
    DEFINE_METHOD2(const char *, sp_search_playlist_uri, (sp_search *p1, int p2))
    DEFINE_METHOD2(const char *, sp_search_playlist_image_uri, (sp_search *p1, int p2))
    ...
    DEFINE_METHOD1(int, sp_search_total_playlists, (sp_search *p1))
    DEFINE_METHOD1(sp_error, sp_search_add_ref, (sp_search *p1))
    DEFINE_METHOD1(sp_error, sp_search_release, (sp_search *p1))
    DEFINE_METHOD1(bool, sp_playlist_is_loaded, (sp_playlist *p1))
    DEFINE_METHOD3(sp_error, sp_playlist_add_callbacks, (sp_playlist *p1, sp_playlist_callbacks *p2, void *p3))
    DEFINE_METHOD3(sp_error, sp_playlist_remove_callbacks, (sp_playlist *p1, sp_playlist_callbacks *p2, void *p3))
    ...
    DEFINE_METHOD2(sp_error, sp_playlist_set_collaborative, (sp_playlist *p1, bool p2))
    DEFINE_METHOD2(sp_error, sp_playlist_set_autolink_tracks, (sp_playlist *p1, bool p2))
    ...
    DEFINE_METHOD1(sp_error, sp_playlist_subscribers_free, (sp_subscribers *p1))
    DEFINE_METHOD2(sp_error, sp_playlist_update_subscribers, (sp_session *p1, sp_playlist *p2))
    DEFINE_METHOD2(bool, sp_playlist_is_in_ram, (sp_session *p1, sp_playlist *p2))
    DEFINE_METHOD3(sp_error, sp_playlist_set_in_ram, (sp_session *p1, sp_playlist *p2, bool p3))
    DEFINE_METHOD2(sp_playlist *, sp_playlist_create, (sp_session *p1, sp_link *p2))
    DEFINE_METHOD3(sp_error, sp_playlist_set_offline_mode, (sp_session *p1, sp_playlist *p2, bool p3))
    ...
    DEFINE_METHOD1(sp_error, sp_playlist_add_ref, (sp_playlist *p1))
    DEFINE_METHOD1(sp_error, sp_playlist_release, (sp_playlist *p1))
    DEFINE_METHOD3(sp_error, sp_playlistcontainer_add_callbacks, (sp_playlistcontainer *p1, sp_playlistcontainer_callbacks *p2, void *p3))
    DEFINE_METHOD3(sp_error, sp_playlistcontainer_remove_callbacks, (sp_playlistcontainer *p1, sp_playlistcontainer_callbacks *p2, void *p3))
    ...
    DEFINE_METHOD1(sp_error, sp_playlistcontainer_add_ref, (sp_playlistcontainer *p1))
    DEFINE_METHOD1(sp_error, sp_playlistcontainer_release, (sp_playlistcontainer *p1))
    DEFINE_METHOD4(int, sp_playlistcontainer_get_unseen_tracks, (sp_playlistcontainer *p1, sp_playlist *p2, sp_track **p3, int p4))
    DEFINE_METHOD2(int, sp_playlistcontainer_clear_unseen_tracks, (sp_playlistcontainer *p1, sp_playlist *p2))
    ...
    DEFINE_METHOD1(sp_error, sp_user_add_ref, (sp_user *p1))
    DEFINE_METHOD1(sp_error, sp_user_release, (sp_user *p1))
    ...
    DEFINE_METHOD1(sp_error, sp_toplistbrowse_add_ref, (sp_toplistbrowse *p1))
    DEFINE_METHOD1(sp_error, sp_toplistbrowse_release, (sp_toplistbrowse *p1))
    ...
    DEFINE_METHOD1(sp_error, sp_inbox_add_ref, (sp_inbox *p1))
    DEFINE_METHOD1(sp_error, sp_inbox_release, (sp_inbox *p1))
    ...
    RESOLVE_METHOD(sp_session_set_private_session)
    RESOLVE_METHOD(sp_session_is_private_session)
    RESOLVE_METHOD(sp_session_set_scrobbling)
    RESOLVE_METHOD(sp_session_is_scrobbling)
    RESOLVE_METHOD(sp_session_set_social_credentials)
    ...
    RESOLVE_METHOD(sp_track_get_playable)
    ...
    RESOLVE_METHOD(sp_artistbrowse_num_tophit_tracks)
    RESOLVE_METHOD(sp_artistbrowse_tophit_track)
    ...
    RESOLVE_METHOD(sp_search_num_playlists)
    RESOLVE_METHOD(sp_search_playlist)
    RESOLVE_METHOD(sp_search_playlist_name)
    RESOLVE_METHOD(sp_search_playlist_uri)
    RESOLVE_METHOD(sp_search_playlist_image_uri)
    ...
    RESOLVE_METHOD(sp_search_total_playlists)
    ...
    RESOLVE_METHOD(sp_playlistcontainer_get_unseen_tracks)
    RESOLVE_METHOD(sp_playlistcontainer_clear_unseen_tracks)
